export function generator$warhammer$dwarfs(type: number) {
  var nm1 = [
    "",
    "",
    "",
  ...
  var rnd = Math.floor(Math.random() * nm9.length);
  var rnd2 = Math.floor(Math.random() * nm10.length);
  while (nm9[rnd] === nm10[rnd2]) {
    rnd2 = Math.floor(Math.random() * nm10.length);
  }
  var nameL = nm9[rnd] + nm10[rnd2];
  if (type === 1) {
    ...
    var names =
      nm5[rnd] + nm6[rnd2] + nm7[rnd3] + nm6[rnd4] + nm8[rnd5] + " " + nameL;
  } else {
    ...
    if (i < 5) {
      names =
        nm1[rnd] + nm2[rnd2] + nm3[rnd3] + nm2[rnd4] + nm4[rnd5] + " " + nameL;
    } else {
